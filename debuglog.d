...
void test()
{
	...
	// staticArray は 配列の先頭を示すが DynamicArray は配列の先頭のアドレスを示している
    ...
    int[] dynamicIntArray = [8, 9, 10, 11, 12, 13, 14, 15];
    dlog("dynamicIntArray: ", dynamicIntArray);
	dlogDump(cast(void*)dynamicIntArray, dynamicIntArray.sizeof * dynamicIntArray.length, "dynamicIntArray");
	dlog("----------------------------------------");
