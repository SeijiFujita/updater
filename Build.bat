@echo off
rem path=C:\Dev\D\dmd.2.072.1\windows\bin;C:\Dev\D\bin;
rem path=C:\Dev\tools\curl\curl-7.55.0-win32-mingw\bin;
rem path=C:\Dev\D\dmd.2.074.1\windows\bin;C:\Dev\D\bin;
path=C:\Dev\D\dmd.2.075.1\windows\bin;C:\Dev\D\bin;
rem zip -9 updater.zip updater.exe updater.conf

rem del getdata.exe
rem dmd -wi getdata.d
rem getdata.exe
@echo on


dmd -wi updapp.d config.d debuglog.d
...
C:\Dev\D\Work\FUtils\test_update>dmd -v 
DMD32 D Compiler v2.075.0
Copyright (c) 1999-2017 by Digital Mars written by Walter Bright

Documentation: http://dlang.org/
Config file: C:\Dev\D\dmd.2.075.0\windows\bin\sc.ini
Usage:
  dmd [<option>...] <file>...
